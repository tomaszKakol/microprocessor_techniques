...
void lcdConfiguration(void)
{
   /* Configure the LCD Control pins
      ...
      RS = P0.23 , WR = P0.24 , RD = P0.25 , DB[0.7] = P2.0...P2.7
      DB[8.15]= P2.0...P2.7
   */

   LPC_GPIO0->FIODIR |= PIN_RS | PIN_RD | PIN_CS | PIN_WR | PIN_LE | PIN_DIR | PIN_EN;

   LPC_GPIO0->FIOSET = PIN_RS | PIN_RD | PIN_CS | PIN_WR | PIN_LE | PIN_DIR | PIN_EN;
}
